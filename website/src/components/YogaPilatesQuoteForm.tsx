...
export default function YogaPilatesQuoteForm({ id = 'quote' }: YogaPilatesQuoteFormProps) {
  function submitQuote(event: FormEvent<HTMLFormElement>) {
    ...
    window.location.href = `https://mail.google.com/mail/?view=cm&fs=1&to=kayzhejiang%40gmail.com&su=${encodeURIComponent('Custom Yoga Pilates Grip Socks Quote Request')}&body=${encodeURIComponent(lines.join('\n'))}`;
  }
