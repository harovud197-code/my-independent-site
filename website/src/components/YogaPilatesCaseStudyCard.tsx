...
export default function YogaPilatesCaseStudyCard({ placement }: YogaPilatesCaseStudyCardProps) {
  return (
    <section className="bg-[#fbf7f4] px-5 py-16 text-[#0c1713] md:px-8 lg:py-24">
      <article className="mx-auto grid max-w-7xl overflow-hidden rounded-3xl border border-[#eaded8] bg-white shadow-[0_24px_65px_rgba(64,35,39,0.09)] lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="relative min-h-[340px] bg-[#f8f1ed] lg:min-h-[500px]">
          <Image src={caseImage} alt="Yoga and Pilates sock collection with five-toe, strap and grip styles" fill sizes="(max-width: 1024px) 100vw, 55vw" className="object-cover" />
        </div>
      </article>
    </section>
  );
