  ...
  return (
    <main className="bg-white text-[#0c1713]">
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 py-16 md:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:py-24">
        <div className="relative aspect-[4/3] overflow-hidden rounded-lg bg-slate-100"><Image src={`${assetPath}/factory/sock-knitting-workshop.jpg`} alt="Computerized sock knitting machines in the PeakMotion factory" fill priority unoptimized sizes="(max-width: 1024px) 100vw, 45vw" className="object-cover" /></div>
