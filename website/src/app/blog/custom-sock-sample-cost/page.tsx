    ...
    <main className="bg-[#f8faf7] text-[#07140f]">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-10 lg:py-16">
          ...
          <div className="relative aspect-[16/11] overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_25px_70px_rgba(15,23,42,0.12)]">
            <Image src={heroImage} alt="Custom sock samples prepared for review before bulk production" fill priority sizes="(max-width: 1024px) 100vw, 52vw" className="object-contain" />
          </div>
        </div>
      </header>
