...
const posts = [
  {
    ...
    href: '/blog/50-vs-100-vs-500-custom-socks-moq',
    desc: 'Compare custom socks MOQ, inventory risk, unit cost, SKU planning and margin before choosing your first or next production quantity.',
    img: '/assets/blog/50-vs-100-vs-500-custom-socks-moq/50-100-500-pairs-custom-socks-moq.png',
    imageClassName: 'object-contain bg-[#f7f8f6]',
    ...
    <main className="bg-white text-[#0c1713]" data-content-version="2026-08-21-blog-private-label-packaging-cover-v2">
      ...
      <section className="bg-[#f7f8f6] px-5 py-12 md:px-8 md:py-16">
        ...
        <Link href={featured.href} className="relative block aspect-[4/3] overflow-hidden bg-[#f7f8f6]">
          <Image src={featured.img} alt={featured.title} fill priority sizes="(max-width: 1024px) 100vw, 54vw" className={featured.imageClassName ?? 'object-cover'} />
        </Link>
