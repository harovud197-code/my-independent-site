...
const faqs = [
  ...
  ['What is a practical MOQ for custom running socks?', 'MOQ can start from 50 pairs per design, while the final minimum depends on yarn, colors, size range, logo construction and packaging requirements.'],
    ...
    <main className="bg-white text-[#0c1713]">
      ...
      <article className="mx-auto max-w-4xl px-5 py-12 md:px-8 md:py-20">
        ...
        <div className="mt-12 space-y-12 text-lg leading-relaxed text-slate-700">
          ...
          <section><h2 className="text-3xl font-black text-[#0c1713]">4. Plan MOQ, timing and packaging together</h2><p className="mt-4">MOQ affects color choices, component sourcing and cost. For custom running socks, selected projects can start from 50 pairs per design, but a final MOQ should be confirmed after the specification is clear. Samples usually take 5-10 business days; standard bulk production is commonly 15-30 days after approval, while complex or larger projects can need longer.</p><p className="mt-4">Decide early whether you need bulk packing, branded bands, retail cards, barcode labels, multipacks or cartons sorted by size and color. Packaging is part of the production brief, not an afterthought. For a casual or collaboration-led range that relies on knitted graphics rather than performance zones, see our <Link href="/products/jacquard-custom-socks" className="font-bold text-[#387116] underline underline-offset-4">custom jacquard socks</Link> product page for artwork, material and packaging considerations.</p></section>
