      ...
      <main className="flex-1 bg-white">
        <article className="max-w-3xl mx-auto py-12 px-5 text-gray-700 leading-relaxed text-left">
          ...
          <section id="overview-running" className="mb-12 scroll-mt-24">
            ...
            <div className="my-6 rounded-xl overflow-hidden aspect-[16/9] bg-gray-50 border border-gray-100 relative">
              <Image src="https://pub-e03187bac82d42569911bb6f89c1d844.r2.dev/blog-running-socks-overview.jpg?v=2" alt="Runner's legs and white shoes in motion" fill className="object-cover" />
            </div>
            <p className="text-slate-700 text-[17px] leading-relaxed mb-6">
          ...
          <section id="materials" className="mb-12 scroll-mt-24">
            ...
            <div className="my-8 rounded-2xl overflow-hidden shadow-md border border-gray-100">
              <Image 
