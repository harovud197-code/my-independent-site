              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-auto space-y-4">
                    ...
                    >
                      {product.id === 1 || product.id === 3 || product.id === 4 || product.id === 5 ? "View Details" : "Get Quote"}
                    </a>
                  </div>
                </div>
              </div>
