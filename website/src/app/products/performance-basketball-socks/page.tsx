...
const assetPath = '/assets/products/performance-basketball-socks';
const message = encodeURIComponent('Hello PeakMotion Socks, I am interested in your Performance Basketball Socks.');

export const metadata: Metadata = {
  title: 'Performance Basketball Socks | PeakMotion Socks',
  description: 'Professional basketball grip sports socks with breathable knit, anti-slip grip dots and OEM private label customization.',
};
  ...
  return (
    <main className="bg-white text-[#0c1713]">
      <section className="mx-auto grid max-w-[1440px] grid-cols-1 items-center gap-10 px-5 py-12 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-20">
        <div className="rounded-[28px] bg-[#f7f8f6] p-5 md:p-10"><img src={`${assetPath}/hero.png`} alt="Professional basketball grip sports socks" className="h-auto w-full object-contain" /></div>
