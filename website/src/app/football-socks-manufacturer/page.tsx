...
export const metadata: Metadata = {
  ...
  description: 'Custom football socks manufacturer for clubs, teams and sports brands. OEM and private label knee-high, crew, grip and non-grip football socks from 50 pairs on selected standard styles.',
...
const faqs = [
  ...
  ['What is the MOQ for custom football socks?', 'Selected standard football sock styles can start from 50 pairs. The final MOQ depends on construction, colorways, crest detail, yarn, grip layout and packaging, so we confirm the practical route after reviewing your brief.'],
  ...
  return (
    <main className="bg-white text-[#0c1713]">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 border-t border-slate-200 pt-6 text-sm font-bold text-slate-700">
              <span><strong className="block text-lg text-[#0c1713]">From 50 pairs</strong>selected standard style</span>
      ...
      <section className="bg-[#0c1713] px-5 py-16 text-white md:px-8 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center"><div><p className="text-sm font-black uppercase tracking-[0.18em] text-[#b4ff2b]">Football Socks MOQ</p><h2 className="mt-3 text-3xl font-black md:text-5xl">Start from 50 pairs on a selected standard style</h2><p className="mt-5 max-w-3xl text-lg leading-relaxed text-slate-300">This starting point suits focused club and brand projects using a selected standard construction. The practical MOQ is confirmed after we review your sock height, colorways, crest method, grip layout, size split and packaging requirements.</p></div><div className="rounded-2xl border border-white/15 bg-white/5 p-7 md:p-8"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#b4ff2b]">Plan before sampling</p><p className="mt-4 text-3xl font-black">From 50 pairs</p><p className="mt-3 leading-relaxed text-slate-300">Selected standard style. For a fully bespoke program, we confirm the MOQ by design and colorway.</p><Link href="/sports-socks-moq-guide" className="mt-6 inline-flex rounded-xl bg-[#b4ff2b] px-5 py-3 text-sm font-black uppercase tracking-wide text-[#0c1713] transition-colors hover:bg-[#a3e627]">Read the MOQ Guide</Link></div></div>
      </section>

      <section className="bg-white px-5 py-16 md:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl"><div className="max-w-3xl"><p className="text-sm font-black uppercase tracking-[0.18em] text-[#679a20]">Related Football Sock Styles</p><h2 className="mt-3 text-3xl font-black md:text-5xl">Choose the construction that fits your football program</h2><p className="mt-5 text-lg leading-relaxed text-slate-600">Explore proven product directions for teamwear, football grip and club distribution, then return with the style that best fits your project.</p></div><div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3"><Link href="/products/mid-calf-football-grip" className="rounded-2xl border border-slate-200 bg-[#f7f8f6] p-7 transition-colors hover:border-[#b4ff2b] hover:bg-[#f4fbe8]"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">Product style</p><h3 className="mt-3 text-2xl font-black">Mid-Calf Football Grip Socks</h3><p className="mt-4 leading-relaxed text-slate-600">A performance-led option for teams looking for a mid-calf silhouette and silicone traction.</p><span className="mt-6 inline-flex font-black text-[#234812] underline underline-offset-4">View product style</span></Link><Link href="/products/crew-soccer-grip" className="rounded-2xl border border-slate-200 bg-[#f7f8f6] p-7 transition-colors hover:border-[#b4ff2b] hover:bg-[#f4fbe8]"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">Product style</p><h3 className="mt-3 text-2xl font-black">Crew Soccer Grip Socks</h3><p className="mt-4 leading-relaxed text-slate-600">A shorter football grip sock direction for training, player kits and football-focused brands.</p><span className="mt-6 inline-flex font-black text-[#234812] underline underline-offset-4">View product style</span></Link><Link href="/custom-grip-socks" className="rounded-2xl border border-slate-200 bg-[#f7f8f6] p-7 transition-colors hover:border-[#b4ff2b] hover:bg-[#f4fbe8]"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">Compare options</p><h3 className="mt-3 text-2xl font-black">Custom Grip Socks</h3><p className="mt-4 leading-relaxed text-slate-600">Explore non-slip constructions for football, studio and performance programs before selecting the right route.</p><span className="mt-6 inline-flex font-black text-[#234812] underline underline-offset-4">Explore grip socks</span></Link></div></div>
      </section>
      ...
      <section className="bg-white px-5 py-16 md:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl"><p className="text-sm font-black uppercase tracking-[0.18em] text-[#679a20]">Customer Case Study</p><h2 className="mt-3 text-3xl font-black md:text-5xl">A consistent football sock program for a South African youth club</h2><p className="mt-5 text-lg leading-relaxed text-slate-600">A South African youth football club needed knee-high football socks that maintained one recognizable team identity across age groups while avoiding sizing and color inconsistency.</p></div>
          <article className="mt-10 overflow-hidden rounded-2xl border border-slate-200">
            <div className="bg-[#0c1713] p-8 text-white md:p-10"><p className="text-sm font-black uppercase tracking-[0.18em] text-[#b4ff2b]">South African Youth Football Club</p><h3 className="mt-3 max-w-3xl text-3xl font-black md:text-4xl">Knee-high football socks organized for age-group distribution</h3><div className="mt-7 flex flex-wrap gap-3">{['Knee-high football socks', 'Jacquard team crest', 'Size-sorted packing', 'Youth age groups'].map((item) => <span key={item} className="rounded-full border border-white/20 px-4 py-2 text-sm font-bold text-slate-200">{item}</span>)}</div></div>
            <div className="grid grid-cols-1 gap-px bg-slate-200 md:grid-cols-3"><div className="bg-white p-7"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">The Challenge</p><p className="mt-4 leading-relaxed text-slate-600">Different age groups needed one unified team appearance while avoiding inconsistent sock sizing and colors.</p></div><div className="bg-[#f4fbe8] p-7"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">Our Solution</p><p className="mt-4 leading-relaxed text-slate-700">The project used knee-high construction, a jacquard team crest and size-sorted packing to support clearer club distribution.</p></div><div className="bg-white p-7"><p className="text-sm font-black uppercase tracking-[0.16em] text-[#679a20]">The Result</p><p className="mt-4 leading-relaxed text-slate-600">The first project delivery was completed, followed by discussions around additional color options.</p></div></div>
            <div className="flex flex-col items-start justify-between gap-5 bg-[#f7f8f6] p-7 md:flex-row md:items-center"><p className="max-w-3xl font-bold leading-relaxed text-slate-700">For multi-size club orders, we can review size splits, crest legibility, color matching and packing logic before sampling.</p><a href="#quote" className="inline-flex shrink-0 rounded-xl bg-[#b4ff2b] px-6 py-4 text-sm font-black uppercase tracking-wide text-[#0c1713] transition-colors hover:bg-[#a3e627]">Discuss Your Team Project</a></div>
          </article>
        </div>
      </section>
