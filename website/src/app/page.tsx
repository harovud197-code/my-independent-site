          ...
          <div className="cards product-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <article key={i} className="product-card reveal p-8 bg-white border border-gray-100 rounded-[26px] shadow-sm hover:shadow-xl transition-all flex flex-col">
                ...
                <Link
                  href={card.title === 'Grip Socks' ? '/products/crew-soccer-grip' : card.title === 'Football Socks' ? '/products/mid-calf-football-grip' : card.title === 'Running Socks' ? '/products/professional-running-athletic-socks' : card.title === 'Private Label' ? '/products/custom-logo-embroidery-socks' : '/products'}
