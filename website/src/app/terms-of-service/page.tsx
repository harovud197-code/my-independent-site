    ...
    <main className="bg-white text-[#0c1713]">
      <article className="mx-auto max-w-4xl px-5 py-14 md:px-8 md:py-20">
        ...
        <div className="mt-10 space-y-10 text-lg leading-relaxed text-slate-700">
          ...
          <section><h2 className="text-2xl font-black text-[#0c1713]">Contact</h2><p className="mt-3">Questions about these terms can be sent to <a className="font-bold text-[#387116] underline underline-offset-4" href="mailto:kayzhejiang@gmail.com?subject=Website%20Terms%20Question">kayzhejiang@gmail.com</a>.</p></section>
